  ...
  module.exports = React.createClass({displayName: "exports",
    render: function() {
      ...
      if (!this.props.songs || this.props.songs.length === 0) {
        alert = React.createElement(SongAlert, null);
      }
      return (
        React.createElement("div", {className: "container"}, 
          React.createElement("div", {className: "page-header"}, 
            React.createElement("h1", null, "Rate the song ", React.createElement("small", null, "Like them all!"))
          ), 
        ...
        React.createElement("tr", null, 
          React.createElement("td", null, 
            ...
            React.createElement("div", {className: "pull-right"}, 
              ...
              React.createElement("button", {type: "button", className: "btn btn-danger pull-right", onClick: this.deleteSong}, 
